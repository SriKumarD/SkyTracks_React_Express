    ...
    return (
      <Router>
        <div>
          ...
          <Switch>
            {/* Add Route Paths */}
            <Route exact path="/bookFlight" component={GetFlights}></Route>
            <Route exact path="/viewBooking" component={GetBooking}></Route>
            <Route path="/" render={()=><Redirect to="/bookFlight"/>} ></Route>
          </Switch>
        </div>
      </Router>
    );
